<template>
  ...
  <div
    class="absolute bottom-0 w-full bg-[#66b1ff] py-2 flex justify-center items-center translate-y-[50%] flex-col transition-all duration-300 ease-in-out hover:translate-y-0 hover:cursor-pointer hover:bg-[#66b1ff] hover:opacity-100"
    @click="showPreview = true"
  >
    <el-icon class="font-bold text-2xl" color="white"><ArrowUpBold /></el-icon>
